 ...
 */
public class IdentifyResponseField extends BaseIdentifyField implements IdentifyField {

    public static final Pattern ADDRESS_PATTERN = Pattern.compile("IDENTIFY_RESPONSE:" + BLOCK_ADDRESS_PATTERN);
